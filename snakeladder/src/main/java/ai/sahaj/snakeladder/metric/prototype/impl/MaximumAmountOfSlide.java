...
@Component("maxSlideAmt")
public class MaximumAmountOfSlide implements MetricGenerator<StatsData<Integer>> {
	...
	public MetricResponse<StatsData<Integer>> generateMetric(String simulationId, MetricRequest statsReq) {
		...
		metricResponse.setMetricName(Stats.AOSMAX);
		metricResponse.setMetricDescription("Maximum amount of slide during the simulation");
