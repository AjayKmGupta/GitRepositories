...
@Component("biggestClimb")
public class BiggestClimbInSingleTurn implements MetricGenerator<StatsData<Integer>> {
	...
	public MetricResponse<StatsData<Integer>> generateMetric(String simulationId, MetricRequest statsReq) {
		...
		metricResponse.setMetricName(Stats.BCINST);
		metricResponse.setMetricDescription("Biggest climb in single turn");
