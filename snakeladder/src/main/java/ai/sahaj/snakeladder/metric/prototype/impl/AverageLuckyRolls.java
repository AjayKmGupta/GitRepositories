...
@Component("avgLuckyRolls")
public class AverageLuckyRolls implements MetricGenerator<StatsData<Double>> {
	...
	public MetricResponse<StatsData<Double>> generateMetric(String simulationId, MetricRequest statsReq) {
		...
		metricResponse.setMetricName(Stats.LKRAVG);
		metricResponse.setMetricDescription("Average lucky rolls during the simulation");
