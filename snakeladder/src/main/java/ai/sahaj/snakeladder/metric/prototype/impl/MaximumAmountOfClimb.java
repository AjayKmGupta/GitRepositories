...
@Component("maxClimbAmt")
public class MaximumAmountOfClimb implements MetricGenerator<StatsData<Integer>> {
	...
	public MetricResponse<StatsData<Integer>> generateMetric(String simulationId, MetricRequest statsReq) {
		...
		metricResponse.setMetricName(Stats.AOCMAX);
		metricResponse.setMetricDescription("Maximum amount of climb during the simulation");
