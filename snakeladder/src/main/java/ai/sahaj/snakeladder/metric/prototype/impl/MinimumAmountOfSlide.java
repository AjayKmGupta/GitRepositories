...
@Component("minSlideAmt")
public class MinimumAmountOfSlide implements MetricGenerator<StatsData<Integer>> {
	...
	public MetricResponse<StatsData<Integer>> generateMetric(String simulationId, MetricRequest statsReq) {
		...
		metricResponse.setMetricName(Stats.AOSMIN);
		metricResponse.setMetricDescription("Minimum amount of slide during the simulation");
