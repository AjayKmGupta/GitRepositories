...
@Component("minUnluckyRolls")
public class MinimumUnluckyRolls implements MetricGenerator<StatsData<Integer>> {
	...
	public MetricResponse<StatsData<Integer>> generateMetric(String simulationId, MetricRequest statsReq) {
		...
		metricResponse.setMetricDescription("Minimum unlucky rolls during the simulation");
